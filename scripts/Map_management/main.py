...
#     calculate_similarity_matrix_and_periodicities, calculate_timeseries, calculate_periodicities, calculate_timeseries2, \
#     strands_test, \
...
def main():
    ...
    if not args.e \
        ...
        print("Nothing to do! Please pass some options.")
